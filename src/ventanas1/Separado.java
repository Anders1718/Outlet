...
public class Separado extends javax.swing.JFrame {
    ...
    public Separado() {
        initComponents();
        this.setTitle("Separado -  " + Conexion.nombreNegocio);
    ...
    private void initComponents() {
        ...
        jButtonAbono.setBackground(new java.awt.Color(255, 255, 255));
        jButtonAbono.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        jButtonAbono.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jLabelMostrarNombre6.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jLabelMostrarNombre4.setForeground(new java.awt.Color(51, 51, 51));
        ...
        getContentPane().add(jLabelLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 30, -1, -1));
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
            ...
            jLabelCantidad.setText(String.valueOf(TablaDatos.getValueAt(seleccionar, 5)));
            pagar = Double.parseDouble(TablaDatos.getValueAt(seleccionar, 6).toString());
